...
<div class="container">
        ...
        <div class="col-md-4">
            <div class="card h-100">
              <div class="card-body text-center">
                ...
                <hr>
                <a href="../storage/png/<?=$d['png']?>" target="iframe">Lihat Data PNG</a>
                <hr>
                Download
                <br>
        ...
        <div class="col-md-4">
            <div class="card h-100">
              <div class="card-body text-center">
                ...
                <hr>
                <a href="../lib/img/kml.png" target="iframe">Lihat Data KML</a>
                <hr>
                Download 
                <br>
        ...
        <div class="col-md-4">
            <div class="card h-100">
              <div class="card-body text-center">
                ...
                <hr>
                <a href="../storage/pdf/<?=$d['pdf']?>" target="iframe">Lihat Data PDF</a>
                <hr>
                Download
    ...
    <div class="ratio ratio-16x9">
        <iframe class="w-100 h-100" frameborder="0" name="iframe"  allowfullscreen></iframe>
    </div>
