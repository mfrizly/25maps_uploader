        ...
        <div class="col-md-4">
            <div class="card h-100">
              <div class="card-body text-center">
                ...
                Download
                <br>
                <a href="../helper/u_download.php?file=<?=$d['png']?>&id=<?=$id_peta?>$j=<?=$jenis_peta?>&type=png">
                     <?=$d['png']?>
                </a>
              </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="card h-100">
              <div class="card-body text-center">
                ...
                Download 
                <br>
                <a href="../helper/u_download.php?file=<?=$d['kml']?>&id=<?=$id_peta?>$j=<?=$jenis_peta?>&type=kml">
                    <?=$d['kml']?>
                </a>
              </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="card h-100">
              <div class="card-body text-center">
                ...
                <hr>
                Download
                <a href="../helper/u_download.php?file=<?=$d['pdf']?>&id=<?=$id_peta?>$j=<?=$jenis_peta?>&type=pdf">
                    <?=$d['pdf']?>
                </a>
              </div>
            </div>
